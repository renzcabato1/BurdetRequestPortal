    ...
    <div class="col-lg-12">
        <div class="ibox ">
            <div class="ibox-content">
                ...
                <form  method='POST' id='myform' action='save-sb-request-non-sap' onsubmit='show();' enctype="multipart/form-data"  >
                    {{ csrf_field() }}
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody class='form-all'>
                                    <tr id='1'>
                                        ...
                                        <td>
                                            <select class='form-control' name='cost_center[1]'  required> 
                                                <option></option>
                                        ...
                                        <td><input class="form-control" type='number' type="text" min='.01' step='0.01' value="1"  id='qty1' class='form-control' name='qty[1]' required></td>
                                                <td>
                                                    <select class='form-control' name='unit_of_measure[1]' id='unit_of_measure1' required> 
                                                        ...
                                                        <td><b><i>VAT Inclusive</i><b><input id='vat_inclusive1' onchange='do_vat_inclusive(1,this.value)' class='form-control' type='number'  step="0.01" min='.01' required>
                                                            ...
                                                            <br><div class="checkbox"><input type='checkbox' name='no_vat[1]'  id='no_vat1' onclick='calculate_no_vat(1)'><label for='no_vat1'><i><h5>Select if Non VAT Vendor</h5></i></div></label>
                                                        </td>
                                                        <td><input id='remaining_balanace1' class='form-control' type='number'  step="0.01" name='remaining_balance[1]' min='.00'  value='0.00'  required></td>
                                                        <td>
                                                            {{-- <input class='form-control' onchange='get_material_description(this.value,1)'  id='material_code1' name='material_code[1]'  placeholder='Material Code' readonly >
                                                             <br> --}}
                                                             <textarea  minlength='10' maxlength='40'  class='form-control' id='material_description1' name='material_description[1]' placeholder='Material Description' required></textarea></td>
                                                        <td><input type='month' class='form-control' min='{{date('Y-m')}}' name='date_needed[1]' required><br> ROI :<input type='file' id='roi1' class='form-control' name='rio[1]' required></td>
                                                        <td style='width:20%;'><textarea  class='form-control' name='remarks[1]' placeholder='Remarks' ></textarea> <br>
                                                            <textarea  class='form-control' name='io_description[1]' placeholder='Description' min='10' max='' id='io_description1' required></textarea>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                        ...
                        function add_row()
                        {
                            ...
                            var  table_append = "<tr id="+id_form+">";
                                // table_append += "<td> <select class='form-control' name='budgted["+id_form+"]'  onchange='do_budget("+id_form+",this.value)' required><option></option> <option value='Budgted'>Existing IO</option> <option value='Not Budgeted'>New IO</option> </select>  <br> <div class='form-"+id_form+"'></div></td>";
                                    ...
                                    table_append += "<td><input  type='number' min='1'  id='qty"+id_form+"' min='.01' step='0.01'  class='form-control' name='qty["+id_form+"]' required></td>";
