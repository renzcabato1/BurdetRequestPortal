                            ...
                            <tbody>
                               ...
                               <td > {{$request->company_info->company_abbreviation}}</td>
                                ...
                                <td > 
                                    ...
                                    {{-- <a href='{{ url('/re-file-sb-request/'.$request->id.'') }}'><button class="btn btn-sm btn-warning" data-toggle="modal"  >Re file</button> </a> --}}
                                    <button class="btn btn-sm btn-danger" data-target="#cancel_remarks{{$request->id}}" data-toggle="modal">Cancel</button> 
                                    <button class="btn btn-sm btn-success" data-target="#reply{{$request->id}}" data-toggle="modal">Reply</button> 
                                </td>
                               </tr>
