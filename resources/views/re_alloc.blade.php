            ...
            <div class="ibox ">
                <div class="ibox-content">
                    <div class="table-responsive">
                        {{-- @include('new_account')     --}}
                        <button data-target="#new_request" data-toggle="modal" type="button" class="btn btn-primary" data-toggle="modal" type="button"><i class="fa fa-upload"></i>&nbsp;New Request </button>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td >
                                        ...
                                        @if($approver->status == "Declined") <span class="label label-danger">{{$approver->status}}</span> @endif <br><br>
                                        @endforeach
                                    </td>
                                    <td>
