...
<div class="modal" id="new_endorsement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            ...
            <form method='POST' action='new-endorsement' onsubmit='show();'  enctype="multipart/form-data" >
