    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class='col-md-10'>
                    <h5 class="modal-title" id="exampleModalLabel">View Request ({{$request->sb_request->company_info->company_abbreviation}}-{{date('Ym',strtotime($request->sb_request->created_at))}}-{{str_pad($request->sb_request->ref_id, 4, '0', STR_PAD_LEFT)}})</h5>
                </div>
                <div class='col-md-2'>
            ...
            <form method='POST' action='cancel-request/{{$request->id}}' onsubmit='show();'  enctype="multipart/form-data" >
                <div class="modal-body">
                    ...
                    <div class="row border-bottom">
                        ...
                        <div class="col-lg-2 border-right">
                            {{$detail->material_code}} <br>
                            {{$detail->material_description}} <br>
                            {{$detail->io_description}} <Br>
                        </div>
                        <div class="col-lg-1 border-right">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-1 border-right border-bottom border-left">
